...
const handler = async (event) => {
    ...
    const url = ((_a = event.queryStringParameters) === null || _a === void 0 ? void 0 : _a.url) || '/';
    ...
    if (isBot) {
        try {
            ...
            const response = await (0, node_fetch_1.default)('https://destiny33.site/', {
                headers: {
            ...
            html = html.replace(/<link rel="canonical" href="https:\/\/destiny33\.site\/">/g, `<link rel="canonical" href="https://destiny33.site${path}">`);
            html = html.replace(/<meta property="og:url" content="https:\/\/destiny33\.site\/">/g, `<meta property="og:url" content="https://destiny33.site${path}">`);
            ...
            html = html.replace(/<title>운명의 매트릭스 \(Destiny Matrix\)<\/title>/g, `<title>${pageTitle}</title>`);
            html = html.replace(/<meta name="description" content="[^"]*">/g, `<meta name="description" content="${pageDescription}">`);
