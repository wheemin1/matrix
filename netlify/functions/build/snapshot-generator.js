...
const handler = async (event) => {
    ...
    try {
        ...
        html = html.replace(/<link rel="canonical" href="https:\/\/destiny33\.site\/">/g, `<link rel="canonical" href="https://destiny33.site${requestedPath}">`);
        html = html.replace(/<meta property="og:url" content="https:\/\/destiny33\.site\/">/g, `<meta property="og:url" content="https://destiny33.site${requestedPath}">`);
