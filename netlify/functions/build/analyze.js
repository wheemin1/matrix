...
// shared/schema.ts
var matrixAnalyses = pgTable("matrix_analyses", {
  id: serial("id").primaryKey(),
  mode: text("mode").notNull(),
  // 'personal' or 'couple'
  personalName: text("personal_name"),
  personalBirthdate: text("personal_birthdate"),
  personalGender: text("personal_gender"),
  // 'male' or 'female'
  person1Name: text("person1_name"),
  person1Birthdate: text("person1_birthdate"),
  person1Gender: text("person1_gender"),
  // 'male' or 'female'
  person2Name: text("person2_name"),
  person2Birthdate: text("person2_birthdate"),
  person2Gender: text("person2_gender"),
  // 'male' or 'female'
  matrixPoints: text("matrix_points").notNull(),
  // JSON string
  createdAt: timestamp("created_at").defaultNow().notNull()
});
var insertMatrixAnalysisSchema = createInsertSchema(matrixAnalyses).omit({
  id: true,
  createdAt: true
}).extend({
...
// client/src/lib/destiny-matrix.ts
