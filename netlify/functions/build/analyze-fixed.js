...
// netlify/functions/analyze-fixed.ts
var analyze_fixed_exports = {};
__export(analyze_fixed_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(analyze_fixed_exports);
...
// netlify/functions/analyze-fixed.ts
var personalAnalysisSchema = z.object({
  mode: z.literal("personal"),
  personalName: z.string().min(1, "\uC774\uB984\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694").max(30, "\uC774\uB984\uC774 \uB108\uBB34 \uAE41\uB2C8\uB2E4").regex(/^[가-힣a-zA-Z\s]+$/, "\uC774\uB984\uC740 \uD55C\uAE00, \uC601\uBB38, \uACF5\uBC31\uB9CC \uD3EC\uD568\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4"),
  personalBirthdate: z.string().min(1, "\uC0DD\uB144\uC6D4\uC77C\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694").refine(
    (date) => {
      const birthDate = new Date(date);
      const now = /* @__PURE__ */ new Date();
      return !isNaN(birthDate.getTime()) && birthDate <= now && birthDate.getFullYear() >= 1900;
    },
    { message: "\uC720\uD6A8\uD55C \uC0DD\uB144\uC6D4\uC77C\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694 (1900\uB144 \uC774\uD6C4)" }
  ),
  personalGender: z.enum(["male", "female"], { required_error: "\uC131\uBCC4\uC744 \uC120\uD0DD\uD574\uC8FC\uC138\uC694" })
});
var coupleAnalysisSchema = z.object({
  mode: z.literal("couple"),
  person1Name: z.string().min(1, "\uCCAB \uBC88\uC9F8 \uC0AC\uB78C\uC758 \uC774\uB984\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694").max(30, "\uC774\uB984\uC774 \uB108\uBB34 \uAE41\uB2C8\uB2E4").regex(/^[가-힣a-zA-Z\s]+$/, "\uC774\uB984\uC740 \uD55C\uAE00, \uC601\uBB38, \uACF5\uBC31\uB9CC \uD3EC\uD568\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4"),
  person1Birthdate: z.string().min(1, "\uCCAB \uBC88\uC9F8 \uC0AC\uB78C\uC758 \uC0DD\uB144\uC6D4\uC77C\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694").refine(
    (date) => {
      const birthDate = new Date(date);
      const now = /* @__PURE__ */ new Date();
      return !isNaN(birthDate.getTime()) && birthDate <= now && birthDate.getFullYear() >= 1900;
  ...
  person2Name: z.string().min(1, "\uB450 \uBC88\uC9F8 \uC0AC\uB78C\uC758 \uC774\uB984\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694").max(30, "\uC774\uB984\uC774 \uB108\uBB34 \uAE41\uB2C8\uB2E4").regex(/^[가-힣a-zA-Z\s]+$/, "\uC774\uB984\uC740 \uD55C\uAE00, \uC601\uBB38, \uACF5\uBC31\uB9CC \uD3EC\uD568\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4"),
  person2Birthdate: z.string().min(1, "\uB450 \uBC88\uC9F8 \uC0AC\uB78C\uC758 \uC0DD\uB144\uC6D4\uC77C\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694").refine(
    (date) => {
      const birthDate = new Date(date);
      const now = /* @__PURE__ */ new Date();
      return !isNaN(birthDate.getTime()) && birthDate <= now && birthDate.getFullYear() >= 1900;
